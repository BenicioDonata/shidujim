    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-busqueda " id="accordion_filtro">
            ...
            <div id="collapseOne" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                ...
                <form  method="get" action="{{route('searchWordUser')}}" name="frm_busqueda" id="frm_busqueda">
                        ...
                        <div class="form-group" style="clear:both;">
                            ...
                            <a type="button" data-toggle="tooltip" data-placement="top" title="Todos los Usuarios" class="btn btnBuscar fas fa-list-ol" href="{{route('dash_admin')}}"></a>
                        </div>
                </form>
                </div>
            </div><!--FIN BUSCADOR-->
